...
\item[{\parbox[t]{6em}{\textit{\large{Dic 2008}}}}]{
	\parbox[t]{\linewidth}{
		\textbf{Simcoax:} autor, mantenedor --- \href{http://github.com/LuisAlejandro/simcoax}{Fuente}
	}
}
\item[{\parbox[t]{6em}{\textit{\large{Dic 2010}}}}]{
	\parbox[t]{\linewidth}{
		\textbf{Cunaguaro:} autor, mantenedor --- \href{http://github.com/LuisAlejandro/cunaguaro}{Fuente}
	}
}
\item[{\parbox[t]{6em}{\textit{\large{Dic 2010}}}}]{
	\parbox[t]{\linewidth}{
		\textbf{Gu\'acharo:} autor, mantenedor --- \href{http://github.com/LuisAlejandro/guacharo}{Fuente}
	}
}
\item[{\parbox[t]{6em}{\textit{\large{Ago 2010}}}}]{
	\parbox[t]{\linewidth}{
		\textbf{Canaima Semilla:} autor, mantenedor --- \href{http://github.com/LuisAlejandro/canaima-semilla}{Fuente}
	}
}
\item[{\parbox[t]{6em}{\textit{\large{Feb 2011}}}}]{
	\parbox[t]{\linewidth}{
		\textbf{Canaima Desarrollador:} autor, mantenedor --- \href{http://github.com/LuisAlejandro/canaima-desarrollador}{Fuente}
	}
}
\item[{\parbox[t]{6em}{\textit{\large{May 2011}}}}]{
	\parbox[t]{\linewidth}{
...
\item[\textit{\large{Programaci\'on}}]{Python, Shell script, Make, PHP, Javascript.}
\item[\textit{\large{Web}}]{Django, jQuery, AngularJS, HTML5, CSS3, Twitter Bootstrap.}
\item[\textit{\large{Virtualización}}]{LXC, Vagrant, Docker, Qemu, Virtualbox.}
\item[\textit{\large{Diagramación}}]{Markdown, reStructuredText, \LaTeX}
