...
\item[{\parbox[t]{6em}{\textit{\large{Ene 2017\\presente}}}}]{
	\parbox[t]{\linewidth}{
		...
		\textit{Desarrollador}\\
		\footnotesize{Generar soluciones a empresas e individuales a través de diferentes portales de freelancing.}
	}
}
\item[{\parbox[t]{6em}{\textit{\large{Feb 2016\\Dic 2016}}}}]{
	\parbox[t]{\linewidth}{
		...
		\footnotesize{Desarrollo y mantenimiento de módulos Odoo e imágenes Docker.}
	}
}
